/// update_animation_index()
 ...
 // Sonic:
    if(character_id = CHAR_SONIC)
    {
       ...
       set_animation("BORED_1",       spr_sonic_idle_1, 0.10,  4, 3, -1, "", 0);        
       set_animation("LOOK",         spr_sonic_look_up, 0.15,  1, 1,  0, "", 0);             
       set_animation("CROUCH",        spr_sonic_crouch, 0.15,   1, 1,  0, "", 0);    
       set_animation("PUSH",            spr_sonic_push, 0.10,  3, 0, -1, "", 0);         
       set_animation("WALK",            spr_sonic_walk, 0.125,  7, 0, -1, "", 0); 
       set_animation("RUN",              spr_sonic_run, 0.25,  3, 0, -1, "", 0);     
       set_animation("PEELOUT",         spr_sonic_dash, 0.60,  3, 1, -1, "", 0);          
       ...
       set_animation("TWIRL",          spr_sonic_twirl, 0.5,   4, 0, -1, "", 0);         
       set_animation("SKID",            spr_sonic_skid, 0.25,  2, 2,  0, "", 0); 
       set_animation("SKID TURN",  spr_sonic_skid_turn, 0.25,  0, 0,  0, "", 0);             
       set_animation("BALANCE",    spr_sonic_balance_1, 0.15,  7, 0, -1, "", 0); 
       set_animation("BALANCE 2",  spr_sonic_balance_2, 0.12,  7, 0, -1, "", 0);        
       set_animation("HURT",            spr_sonic_hurt, 0.10,  0, 0, -1, "", 0); 
