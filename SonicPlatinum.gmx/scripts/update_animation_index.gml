/// update_animation_index()
 ...
 // Sonic:
    if(character_id = CHAR_SONIC)
    {
       ...
       set_animation("DASH",            spr_sonic_dash, 0.25,  3, 0, -1, "", 0);      
       ...
       set_animation("FALL",         spr_sonic_falling, 0.15,  2, 1, -1, "", 0);            
       ...
       set_animation("WIN",              spr_sonic_win, 0.10,  2, 1, -1, "", 0); 
       set_animation("WIN FINISH",spr_sonic_win_finish, 0.10,  2, 1, -1, "STAND", 0);    
    }
